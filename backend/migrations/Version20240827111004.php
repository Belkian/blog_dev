 ...
 */
final class Version20240827111004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD approved TINYINT(1) NOT NULL, DROP categorie_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie_id INT DEFAULT NULL, DROP approved');
